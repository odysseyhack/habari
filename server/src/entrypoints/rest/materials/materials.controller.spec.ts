...
describe('Materials Controller', () => {
  ...
  describe('create', () => {
    it('should return all materials', async () => {
      const result = {
        'data': 'TODO: implement materials POST endpoint'
      };
  ...
  describe('findAll', () => {
    it('should return all materials', async () => {
      const result = {
        'data': 'TODO: implement materials GET endpoint'
      };
  ...
  describe('findById', () => {
    it('should return all materials', async () => {
      const result = {
        'data': 'TODO: implement materials GET:id endpoint',
        'id': '42'
      };
  ...
  describe('update', () => {
    it('should return all materials', async () => {
      const result = {
        'data': 'TODO: implement materials PUT:id endpoint',
        'id': '42'
      };
  ...
  describe('remove', () => {
    it('should return all materials', async () => {
      const result = {
        'data': 'TODO: implement materials DELETE:id endpoint',
        'id': '42'
      };
