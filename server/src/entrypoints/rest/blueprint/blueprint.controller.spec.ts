...
describe('Blueprint Controller', () => {
  ...
  describe('create', () => {
    it('should return all blueprint', async () => {
      const result = {
        'data': 'TODO: implement blueprint POST endpoint'
      };
  ...
  describe('findAll', () => {
    it('should return all blueprint', async () => {
      const result = {
        'data': 'TODO: implement blueprint GET endpoint'
      };
  ...
  describe('findById', () => {
    it('should return all blueprint', async () => {
      const result = {
        'data': 'TODO: implement blueprint GET:id endpoint',
        'id': '42'
      };
  ...
  describe('update', () => {
    it('should return all blueprint', async () => {
      const result = {
        'data': 'TODO: implement blueprint PUT:id endpoint',
        'id': '42'
      };
  ...
  describe('remove', () => {
    it('should return all blueprint', async () => {
      const result = {
        'data': 'TODO: implement blueprint DELETE:id endpoint',
        'id': '42'
      };
