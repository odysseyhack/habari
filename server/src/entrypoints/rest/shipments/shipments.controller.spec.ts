...
describe('Shipments Controller', () => {
  ...
  describe('create', () => {
    it('should return all shipments', async () => {
      const result = {
        'data': 'TODO: implement shipments POST endpoint'
      };
  ...
  describe('findAll', () => {
    it('should return all shipments', async () => {
      const result = {
        'data': 'TODO: implement shipments GET endpoint'
      };
  ...
  describe('findById', () => {
    it('should return all shipments', async () => {
      const result = {
        'data': 'TODO: implement shipments GET:id endpoint',
        'id': '42'
      };
  ...
  describe('update', () => {
    it('should return all shipments', async () => {
      const result = {
        'data': 'TODO: implement shipments PUT:id endpoint',
        'id': '42'
      };
  ...
  describe('remove', () => {
    it('should return all shipments', async () => {
      const result = {
        'data': 'TODO: implement shipments DELETE:id endpoint',
        'id': '42'
      };
