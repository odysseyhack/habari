...
describe('Donators Controller', () => {
  ...
  describe('findAll', () => {
    it('should return all donors', async () => {
      const result = {
        'data': 'TODO: implement donors GET endpoint'
      };
  ...
  describe('findById', () => {
    it('should return all donors', async () => {
      const result = {
        'data': 'TODO: implement donors GET:id endpoint',
        'id': '42'
      };
  ...
  describe('update', () => {
    it('should return all donors', async () => {
      const result = {
        'data': 'TODO: implement donors PUT:id endpoint',
        'id': '42'
      };
  ...
  describe('remove', () => {
    it('should return all donors', async () => {
      const result = {
        'data': 'TODO: implement donors DELETE:id endpoint',
        'id': '42'
      };
