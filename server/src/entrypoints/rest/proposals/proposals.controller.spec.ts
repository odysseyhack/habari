...
describe('Proposals Controller', () => {
  ...
  describe('create', () => {
    it('should return all proposals', async () => {
      const result = {
        'data': 'TODO: implement proposals POST endpoint'
      };
  ...
  describe('findAll', () => {
    it('should return all proposals', async () => {
      const result = {
        'data': 'TODO: implement proposals GET endpoint'
      };
  ...
  describe('findById', () => {
    it('should return all proposals', async () => {
      const result = {
        'data': 'TODO: implement proposals GET:id endpoint',
        'id': '42'
      };
  ...
  describe('update', () => {
    it('should return all proposals', async () => {
      const result = {
        'data': 'TODO: implement proposals PUT:id endpoint',
        'id': '42'
      };
  ...
  describe('remove', () => {
    it('should return all proposals', async () => {
      const result = {
        'data': 'TODO: implement proposals DELETE:id endpoint',
        'id': '42'
      };
